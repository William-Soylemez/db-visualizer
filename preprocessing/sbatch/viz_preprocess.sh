...
#
# This file is the canonical copy. On the cluster, submit it directly or symlink
# it into the philharmonic sbatch_jobs dir (see preprocessing/cluster_setup.md).
# It reuses the philharmonic job harness (common.sh) for paths + helpers.
#
# Usage:
